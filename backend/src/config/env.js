...
const env = {
  ...
  evolutionApiUrl: process.env.EVOLUTION_API_URL || 'https://evolution-api-production-88fe.up.railway.app',
  evolutionApiKey: process.env.EVOLUTION_API_KEY,
  backendPublicUrl: process.env.BACKEND_PUBLIC_URL || 'https://zellu-production.up.railway.app',
